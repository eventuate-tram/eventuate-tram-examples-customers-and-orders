...
public class CustomerService {
  ...
  public Customer createCustomer(String name, Money creditLimit) {
    ResultWithEvents<Customer, CustomerEvent> customerWithEvents = Customer.create(name, creditLimit);
    Customer customer = customerRepository.save(customerWithEvents.result());
    customerEventPublisher.publish(customer, customerWithEvents.events());
    return customer;
  }
