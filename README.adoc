...
1. In your browser, create a codespace for the repository by clicking the "Code" button, selecting "Codespaces", and creating a Codespace.
This should open Visual Studio Code in the browser.
